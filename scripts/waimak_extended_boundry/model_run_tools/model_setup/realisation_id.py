...
def get_model_name_path(model_id):
    ...
    model_dict = {
        # copy of the NsmcBase, made by Connor 
        # don't want to mess this code up so adding a the directory here
        'NsmcBase': "{}\pre-stocastic_extended_models\NsmcBase\AW20171024_2_i2_optver\i2\mf_aw_ex.nam".format(smt.sdp)
    }
