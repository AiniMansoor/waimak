...
sdp_required = path + r"\model\required" # todo set
...
sdp_recommended = path + r"\model\recommended" # todo set
...
temp_file_dir = path + r"\model\temp_file_dir" # todo set
assert temp_file_dir is not None, 'temp file dir must be set'
assert os.path.exists(temp_file_dir), 'temp file dir must exist'

loaded_model_realisation_dir = path + r"\model\loaded_model_realisation_dir" # todo set
