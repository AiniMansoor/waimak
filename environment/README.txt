...
This folder can be copied to the local drive in order to be useful. This is not the best option
 for creating and using the python environment but it is included here to provide additional
 redundancy in this key step.  This was made on a windows 10 machine.  
